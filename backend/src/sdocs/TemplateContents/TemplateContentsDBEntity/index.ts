...
export interface TemplateContentsDBEntityInterface{
 ...
 */
export class TemplateContentsDBEntity implements TemplateContentsDBEntityInterface{
    template_summary_id: string;
    template_content_id: string;
    order: number;
    content_type: string;
    ...
    constructor(template_summary_id: string,template_content_id: string, order: number, content_type: string, contents: string){
