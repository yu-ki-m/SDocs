...
<template>
    <QuillEditor data-gid="f492fcdd-5fbd-4cde-9f8f-624c7fc8a57d" :placeholder="''" :theme="'bubble'"  :content="value" :content-type="'html'" @update:content="inputValue" :toolbar="costomToolbar">
    </QuillEditor>
</template>
