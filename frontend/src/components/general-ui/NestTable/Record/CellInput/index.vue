...
<template>
    <QuillEditor data-gid="6f279d0f-92eb-46ae-9cc9-7c6fc4c62b41" :placeholder="''" :theme="'bubble'"  :content="value" :content-type="'html'" @update:content="inputValue" :toolbar="costomToolbar">
    </QuillEditor>
</template>
