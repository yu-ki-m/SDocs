...
import { StubTemplateSummariesRepository } from '../../sdocs/TemplateSummary.Repository/StubTemplateSummaryRepository'
...
describe('表示', () => {
    ...
    describe('ヘッダー', () => {
        it('ヘッダー文字が表示されるコト', async () => {
            ...
            const wrapper = mount(MainLayout, { props, slots: { default: '' } })
        ...
        it('新しいタブを表示するボタンがクリックされる', async () => {
            ...
            mount(MainLayout, { props, slots: { default: '' } })
                .find("[id='header_top-new-tab']")
                .trigger('click')
        ...
        `
            ...
            const wrapper = mount(MainLayout, { props, slots: { default: TestComponent } })
