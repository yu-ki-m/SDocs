    ...
    <header :class="style.headerContainer" >
        <div :class="style.header">
            <div :class="style.headerLeft">
                <a id="header_top-icon" @click="(event)=>{props.routerWrapper.toTopPage()}">
                    <img  name="toTop" :class="style.logo" :src="logo" alt="Top" />
                </a>
                <div :class="style.logoCharacters">
                    SDocs
                </div>
            </div>
            <div :class="style.headerRight">
                <a id="header_top-new-tab" @click="(event)=>{props.windowWrapper.toTopNewTab()}" >
