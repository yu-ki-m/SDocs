...
describe('表示', () => {
    ...
    describe('ヘッダー', () => {
        it.concurrent('ヘッダーコンポーネントの表示確認', async () => {
            // * Arrange
            const { props } = setup()
    ...
    describe('メイン', () => {
        it.concurrent('メイン領域が表示されている', async () => {
            // * Arrange
            const { props } = setup()
        ...
        it.concurrent('テンプレート一覧に含まれているDocsサマリーの一覧が表示される', async () => {
            // * Arrange
        ...
        it.concurrent('テンプレートに解説が表示されている', async () => {
            // * Arrange
            const { props, stubTemplateSummariesRepository } = setup()
            const templateSummaries: TemplateSummary[] = structuredClone(templateSummariesA)
            stubTemplateSummariesRepository.getAll_returnValue = templateSummaries
        ...
        it.concurrent('テンプレートにタグが表示されている', async () => {
            // * Arrange
            const { props, stubTemplateSummariesRepository } = setup()
            const templateSummaries: TemplateSummary[] = structuredClone(templateSummariesA)
            stubTemplateSummariesRepository.getAll_returnValue = templateSummaries
        ...
        it.concurrent(
            'テンプレートサマリーをクリックすると遷移先パス(/editor)とURLパラメータ(?templete=<id>)を渡す',
            async () => {
                // * Arrange
