...
onMounted( async ()=>{
    ...
    templateSummariesResult.forEach(
        ...
        <template #default>
            <main :class="style.main" id="top-page">
                <div id="template-summaries" :class="style.templateSummaries">
                    <div v-for="templateSummary in templateSummaries" :key="templateSummary.id" :class="style.templateSummary" >
                        <a @click="()=>{toEditorPage(templateSummary.id)}" >
                            ...
                            <div :class="style.templateTags">
                                <div v-for="tag in templateSummary.tags" :class="style.templateTag" :key="tag.tagViewName">{{tag.tagViewName}}</div>
                            </div>
                        </a>
                    </div>
                </div>
